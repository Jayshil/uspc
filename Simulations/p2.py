...
pout = os.getcwd() + '/Simulations/Analysis/Realistic1807_30Obs'
nobs = 30
fpfs = 39.7*1e-6
prec = 350*1e-6
...
for obs in range(nobs):
    tim1, fl1, fle1 = utils.generate_occ_lc(tim=times, per=per, t0=tc+(obs*per), rprs=rprs, bb=bb, ar=ar, fp=fpfs, mflux=np.random.normal(0., 0.0001), prec=prec)
